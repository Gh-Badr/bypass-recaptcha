...
def calculate_accuracy():
    ...
    # Function to parse the list from a CSV row
    ...
    with open('reordered_human_responses.csv', mode='r') as file1, open('reordered_responses.csv', mode='r') as file2:
        for line1, line2 in zip(file1, file2):
            ...
            size = int(size_str1)
            total_choices = 9 if size == 3 else 16
            ...
            all_choices = set(range(1, size**2 + 1))
    ...
    return count_above_90_percent

# Print the number of times the accuracy exceeds 90%
print(f"Pourcentage of times the score exceeds 90%: {calculate_accuracy()}%")